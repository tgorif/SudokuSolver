...
public class BacktrackingLeastConstraint implements IStrategySolve{
    ...
    public boolean solve(int[][] grid) {
        ...
        tiles=manager.getFilteredList(Comparator.comparingInt((Tile t) -> t.getCandidates().size()).reversed());
        return solve(tiles);
    }
